  ...
  return (
    <section className="px-6 py-20 md:px-12 md:py-24">
      <div className="mx-auto grid max-w-6xl gap-10 rounded-3xl border border-stone-200/15 bg-stone-900/30 p-8 md:grid-cols-2 md:p-12">
        <div>
          <p className="text-xs uppercase tracking-[0.24em] text-stone-400">About Studio</p>
        ...
        <p className="text-base leading-relaxed text-stone-300">
          Our practice develops architecture through site-specific research, refined geometry, and careful material articulation. Each project is developed as a balance between functionality, emotion, and environmental performance.
        </p>
      </div>
    </section>
  );
