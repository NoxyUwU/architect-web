  ...
  return (
    <Link href={`/projects/${project.slug}`} className="group block rounded-2xl border border-stone-200/15 bg-stone-900/30 p-5 transition hover:border-stone-300/30">
      <div className="relative h-56 overflow-hidden rounded-xl">
        <Image src={project.coverImage} alt={`${project.title} cover image`} fill className="object-cover transition duration-300 group-hover:scale-[1.03]" sizes="(max-width: 768px) 100vw, 33vw" />
      </div>
